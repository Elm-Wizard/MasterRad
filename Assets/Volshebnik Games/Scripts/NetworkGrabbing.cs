...
public class NetworkGrabbing : MonoBehaviourPunCallbacks, IPunOwnershipCallbacks
{
    ...
    void Update()
    {
        if (isBeingHeld)
        {
            ...
            rb.isKinematic = true;
            gameObject.layer = 11; // set to inHand layer
        ...
        else
        {
            ...
            gameObject.layer = 9; // set to interactable layer
    ...
    {
        // insurance that when we grab an object, we will become owner of only that object, not all others

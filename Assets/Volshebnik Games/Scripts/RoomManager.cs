...
public class RoomManager : MonoBehaviourPunCallbacks
{
    ...
    void Start()
    {
        PhotonNetwork.AutomaticallySyncScene = true; //sinh scena za sve igrace
        if (!PhotonNetwork.IsConnectedAndReady) // check da li smo connectovani na servere i za joinvanje lobby-ju
        {
    ...
    public void OnEnterButtonClicked_Outdoor()
    {
        ...
        PhotonNetwork.JoinRandomRoom(expectedCustomRoomProperties, 0); // 0 je maxExpectedPlayers, 0 oznacava neograniceno
    }
    ...
    public override void OnConnectedToMaster()
    {
        ...
        PhotonNetwork.JoinLobby(); // ovo jer se homescene loaduje dva puta, iz open world scena i login scene, da bi se uvek connectovali na default lobby
    ...
    public override void OnJoinedRoom() // samo za lokalnog igraca
    {
    ...
    public override void OnRoomListUpdate (List<RoomInfo> roomList)
    {
        ...
        foreach (RoomInfo room in roomList)
        {
            ...
            {
                // Update occupancy polje za outdoor
            ...
            {
                // Update occupancy polje za school
